...
if __name__ == "__main__":
    ...
    for idx in range(len(lane_ratios)):
        ...
        # Before calling reorder_vertex
        print(opp_outer_bound.shape)  # Should ideally be (N, 2)
        print(opp_outer_bound.dtype)  # Should be an integer type, e.g., np.int32
