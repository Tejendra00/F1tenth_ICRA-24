...
class PurePursuit(Node):
    ...
    def __init__(self):
        ...
        self.weight_list_1 = self.waypoints_curve1[:, 3]  # Assuming 4th column is weight
        self.weight_list_2 = self.waypoints_curve2[:, 3]
        ...
        self.yaw_list = self.current_waypoints[:, 4]
...
########################################### Callback ############################################
    ...
    def pose_callback(self, pose_msg):
        ...
        self.weight_list = self.current_waypoints[:, 3]
        ...
        if self.obstacles is not None:
            ...
            print(self.weight_list_2[curr_target_idx])

            if abs(angle_to_opponent) < angular_threshold:
                if distance_to_opponent < 2.0 and self.weight_list[curr_target_idx]==0.1:
                    target_v *= distance_to_opponent / 2.0
                    print("slwoing down")
                switching_distance = 3.0  # Distance threshold for path switching
